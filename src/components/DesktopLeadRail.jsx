      ...
      <div className="pointer-events-auto rounded-2xl border border-white/55 bg-[#0f1720f2] p-2 shadow-[0_20px_50px_rgba(10,12,20,0.35)] backdrop-blur">
        <div className="grid grid-cols-1 gap-2">
          <a
            ...
            onClick={() => trackLeadEvent("call_click", { placement: "desktop_sticky_rail" })}
          ...
          <a
            href={smsHref}
            onClick={() => trackLeadEvent("sms_click", { placement: "desktop_sticky_rail" })}
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/30 bg-white/8 px-4 py-2.5 text-sm font-semibold text-white"
