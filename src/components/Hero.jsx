    ...
    const slides = [
        {
          ...
          image: "https://cdn.home-designing.com/wp-content/uploads/2018/09/modern-chandeliers.jpg"
        },
        {
          title: "Design Modern Interiors",
          image: "https://cdn.home-designing.com/wp-content/uploads/2018/09/Wood-store-ideas.jpg"
        },
        {
    ...
    <div className="body-bg grid grid-cols-3 h-[550px] mt-14">
       <div className="flex flex-col justify-center items-start items-center p-4">
        ...
        <div className="flex flex-row mt-20">
            <button onClick={prev} className="px-4 py-2 text-black rounded hover:bg-gray-700 transition">
            ← 
            </button>
            <button onClick={next} className="px-4 py-2 text-black rounded hover:bg-gray-700 transition">
            → 
            </button>
        </div>
       </div>
